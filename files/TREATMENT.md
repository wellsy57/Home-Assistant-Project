...
* **SOLIDS REMOVAL FILTRATE HARVESTING** Treatment and filtration produces a high nutrient solid waste stream which is filtered and removed to compost heaps for later garden and lawn use OR pumped to sewer if not able to handle the quantity produced.
